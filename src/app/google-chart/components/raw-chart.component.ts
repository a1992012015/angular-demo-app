...
import { ChartErrorEvent, ChartEvent } from '../interfaces/events.interface';
import { ScriptLoaderService } from '../script-loader/script-loader.service';
import ChartSelection = google.visualization.ChartSelection;
...
export class RawChartComponent implements OnInit, OnChanges, AfterViewInit, OnDestroy {
  ...
  @Output()
  select = new EventEmitter<ChartSelection[]>();
