...
export class GoogleChartTestComponent implements OnInit {
  ...
  // private generateTooltipForFrostChart(title: Date, label: string, time: Date, color: string): string {
  //   return `<div class="line-chart-tooltip">
  //             <div class="title">${formatDate(title, 'yyyy', this.localeId, 'UTC')}</div>
